...
$sql = "SELECT e.expense_id, u.name AS user_name, c.category_name, 
        ...
        WHERE 1";
// $sql="SELECT e.expense_id, u.name 
//         AS user_name, c.category_name, e.amount, e.expense_date
//         FROM expenses e 
//         JOIN users u, categories c ON e.user_id=u.user_id AND e.category_id=c.category_id
//         WHERE 1=1";
