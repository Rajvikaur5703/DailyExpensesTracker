...
if ($user_id != "") {
    $sql .= " AND e.user_id = '" . mysqli_real_escape_string($conn, $user_id) . "'"; //used to escape special characters from Sql injection
}

if ($category != "") {
    $sql .= " AND e.category_id = '" . mysqli_real_escape_string($conn, $category) . "'";
}
...
<head>
    ...
    <link rel="stylesheet" href="../style/admin/manage_expenses.css">
</head>
<body>
    <header>
        <h1>Admin Panel</h1>
    ...
    <div class="container">
        ...
        <form action="manage_expenses.php" method="POST" class="filter-form">
         ...
         <button type="submit" class="filter-btn">Filter</button>
          <button type="button" class="clear-btn" onclick="window.location.href='manage_expenses.php'">Clear</button>
