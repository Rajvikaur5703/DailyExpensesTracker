...
$highest = $conn->query("SELECT MAX(amount) AS highest FROM expenses WHERE user_id='$user'")
                 ->fetch_assoc()['highest'] ?? 0; 

// Fetch recent 5 expenses 
$recent_expenses_query = "SELECT e.expense_id, e.amount, e.expense_date, c.category_name 
                          FROM expenses e 
