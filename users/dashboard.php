...
// Show warning if no income added yet
$no_income_warning = ($total_income == 0);
/* =======================
...
<body> 
    ...
    <div class="dashboard-container">
        <?php if ($no_income_warning): ?>
    <div class="alert-warning">
        ⚠️ You haven’t added any income yet. Your balance may not be accurate.
        <a href="add_income.php" class="add-income-link">Add Income</a>
    </div>
<?php endif; ?> 
        <!-- Summary Cards --> 
                                    ...
                                    <tr>
                                        ...
                                        <td class="action">
                                            <a href="dashboard.php?delete_expense=<?= $row['expense_id'] ?>" 
                                               onclick="return confirm('Are you sure you want to delete this expense?');">🗑️</a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
